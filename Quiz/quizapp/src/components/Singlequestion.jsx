...
class Singlequestion extends React.Component {
  ...
  handleClick = (event) => {
    ...
    let answer = currentQuestion && currentQuestion.correct_answer;
  ...
  render() {
    ...
    let questionsArr = this.props.question.data;
    console.log(this.props.question.data, 'check')
    let currentQuestion = questionsArr[this.state.currentIndex];
    let answer = currentQuestion && currentQuestion.correct_answer;
    let rightOption;
    let options = currentQuestion && currentQuestion.incorrect_answers
      .concat(answer)
